...
#     - Start the paragraph *exactly* with: “[First Name] demonstrates high/moderate/low leadership potential…”
#     - Describe the candidate's likely workplace behaviors based on the provided score interpretations from the dictionary.
#     - Synthesize patterns across the BS and TI data, using the provided mapping. Focus on standout strengths and development areas.
...
# **EXAMPLE 1:**
# **INPUT:** Name: Sub 1, Gender: M, Steers Changes: 5, Manages Stakeholders: 4, Drives Results: 5, Thinks Strategically: 4, Solves Challenges: 5, Develops Talent: 3, Drive Potential: 4, Contribution: 5, Purpose: 4, Achievement: 2, Learning Potential: 3, Mastery: 3, Growth: 3, Insightful: 3, People Potential: 4, Collaboration: 4, Empathy: 4, Sociable: 5, Strategic Potential: 4, Awareness: 5, Autonomy: 3, Perspective: 4, Execution Potential: 5, Resourcefulness: 5, Efficacy: 5, Resilience: 5, Change Potential: 4, Agility: 5, Ambiguity: 5, Venturesome: 3
# **CORRECT OUTPUT:**
...
# **EXAMPLE 2:**
# **INPUT:** Name: John Doe, Gender: M, Steers Changes: 2, Manages Stakeholders: 3, Drives Results: 1, Thinks Strategically: 2, Solves Challenges: 3, Develops Talent: 1, Drive Potential: 2, Contribution: 2, Purpose: 2, Achievement: 1, Learning Potential: 2, Mastery: 1, Growth: 3, Insightful: 2, People Potential: 3, Collaboration: 3, Empathy: 3, Sociable: 4, Strategic Potential: 3, Awareness: 3, Autonomy: 3, Perspective: 3, Execution Potential: 3, Resourcefulness: 3, Efficacy: 3, Resilience: 3, Change Potential: 2, Agility: 3, Ambiguity: 3, Venturesome: 3
# **CORRECT OUTPUT:**
...
# **EXAMPLE 3:**
# **INPUT:** Name: Jane Doe, Gender: F, Steers Changes: 1, Manages Stakeholders: 1, Drives Results: 2, Thinks Strategically: 1, Solves Challenges: 2, Develops Talent: 4, Drive Potential: 3, Contribution: 2, Purpose: 3, Achievement: 4, Learning Potential: 4, Mastery: 4, Growth: 5, Insightful: 3, People Potential: 2, Collaboration: 3, Empathy: 2, Sociable: 1, Strategic Potential: 2, Awareness: 1, Autonomy: 2, Perspective: 3, Execution Potential: 2, Resourcefulness: 2, Efficacy: 1, Resilience: 2, Change Potential: 2, Agility: 1, Ambiguity: 1, Venturesome: 3
# **CORRECT OUTPUT:**
...
# **EXAMPLE 4:**
# **INPUT:** Name: Anvita Sirohi, Gender: F, Steers Changes: 3, Manages Stakeholders: 2, Drives Results: 2, Develops Talent: 4, Drive Potential: 4, Contribution: 4, Purpose: 4, Achievement: 1, Learning Potential: 3, Mastery: 3, Growth: 3, Insightful: 3, People Potential: 5, Collaboration: 5, Empathy: 5, Sociable: 4, Strategic Potential: 4, Awareness: 4, Autonomy: 3, Perspective: 5, Execution Potential: 4, Resourcefulness: 4, Efficacy: 4, Resilience: 5, Change Potential: 4, Agility: 4, Ambiguity: 5, Venturesome: 3
# **CORRECT OUTPUT:**
...
# **EXAMPLE 5:**
# **INPUT:** Name: Sub 5, Gender: M, Steers Changes: 2, Manages Stakeholders: 3, Drives Results: 2, Thinks Strategically: 2, Solves Challenges: 3, Develops Talent: 2, Drive Potential: 3, Contribution: 2, Purpose: 3, Achievement: 3, Learning Potential: 4, Mastery: 5, Growth: 5, Insightful: 3, People Potential: 4, Collaboration: 3, Empathy: 2, Sociable: 4, Strategic Potential: 3, Awareness: 2, Autonomy: 3, Perspective: 2, Execution Potential: 4, Resourcefulness: 4, Efficacy: 4, Resilience: 3, Change Potential: 3, Agility: 3, Ambiguity: 2, Venturesome: 3
# **CORRECT OUTPUT:**
...
def create_sample_template():
    ...
    columns = [
        'Name', 'Gender', 'Steers Changes', 'Manages Stakeholders', 'Drives Results',
        'Thinks Strategically', 'Solves Challenges', 'Develops Talent', 'Drive Potential',
        'Contribution', 'Purpose', 'Achievement', 'Learning Potential', 'Mastery',
        'Growth', 'Insightful', 'People Potential', 'Collaboration', 'Empathy',
        'Sociable', 'Strategic Potential', 'Awareness', 'Autonomy', 'Perspective',
        'Execution Potential', 'Resourcefulness', 'Efficacy', 'Resilience',
        'Change Potential', 'Agility', 'Ambiguity', 'Venturesome'
    ]
    # Create a sample row
    sample_data = {
        'Name': ['Jane Doe'], 'Gender': ['F'], 'Steers Changes': [1.0], 'Manages Stakeholders': [1.0],
        'Drives Results': [2.0], 'Thinks Strategically': [1.0], 'Solves Challenges': [2.0],
        'Develops Talent': [4.0], 'Drive Potential': [3.0], 'Contribution': [2.0], 'Purpose': [3.0],
        'Achievement': [4.0], 'Learning Potential': [4.0], 'Mastery': [4.0], 'Growth': [5.0],
        'Insightful': [3.0], 'People Potential': [2.0], 'Collaboration': [3.0], 'Empathy': [2.0],
        'Sociable': [1.0], 'Strategic Potential': [2.0], 'Awareness': [1.0], 'Autonomy': [2.0],
        'Perspective': [3.0], 'Execution Potential': [2.0], 'Resourcefulness': [2.0],
        'Efficacy': [1.0], 'Resilience': [2.0], 'Change Potential': [2.0], 'Agility': [1.0],
        'Ambiguity': [1.0], 'Venturesome': [3.0]
    }
...
st.download_button(
    ...
    data=sample_excel,
    file_name="candidate_scores_template.xlsx",
